...
function checkBox() {
    ...
    if (mixed != 0) {
        ...
        passWord.innerHTML = 'Check a box below'
    }
}
// Srength
...
toggle.addEventListener("click", () => {
    if (toggle.checked) {
        ...
        document.documentElement.style.setProperty('--BackGroundBody', "#fff");
        document.documentElement.style.setProperty('--BackGroundApp', "#f0f0f6");
        document.documentElement.style.setProperty('--PrimaryBtn', "#363bd2");
        ...
        document.documentElement.style.setProperty('--BackGroundBody', "#0a1217");
        document.documentElement.style.setProperty('--BackGroundApp', "#182a36d2");
        document.documentElement.style.setProperty('--PrimaryBtn', "#a7aaff");
